	...
	<div class="login-form">
		<iron-form id="form3">
			<form name="userForm" id="userForm">
					...
					<paper-input type="text" name="name" label="User Name" id="username" required error-message="password should not be empty" auto-validate maxlength="10"></paper-input>
					<paper-input type="password" id="password" label="Password"  required error-message="password should not be empty" auto-validate maxlength="5"></paper-input><br>
					<!-- Raised button -->
